# Deploying Ona World Kernel on AWS
...
> https://onaworld.example. Re-running
...
`https://github.com/GitOnaAI/ona-world-kernel.git` anonymously. If you
...
- **Production**: point `admin.onaworld.example` at the instance
