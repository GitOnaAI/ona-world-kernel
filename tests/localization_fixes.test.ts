...
// the localized table rather than the English fallback.
beforeAll(async () => {
...
// COPIED_ALLOW = blocked server cognate rows; ALLOW_V07_SLASH = the
...
// --- H3: server_i18n DICT completeness (the Record<string,string> dict lacks : typeof en) ---
describe('H3: DICT key parity, non-empty values, placeholder integrity', () => {
  ...
  // near the top of this file): the blocked server cognate rows.
