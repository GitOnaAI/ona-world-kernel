...
export const CLASSES: Record<PlayerClass, ClassDef> = {
  ...
  // Rootwarden: an exact numeric reskin of the hunter (same stats/curves/costs/
  // ranks/coefficients), retheme only. Two deliberate roster differences vs the
  // hunter: MAIL armor (equipment_rules.ts MAIL_CLASSES) and it keeps the ROG
  // reward archetype (data.ts REWARD_ARCHETYPE). Resource is mana; permanent pet
  // (isPetClass). Do not retune: any balance edit must move the hunter too.
  rootwarden: {
    id: 'rootwarden',
    name: 'Rootwarden',
    baseStats: { str: 14, agi: 25, sta: 19, int: 13, spi: 14, armor: 45 },
...
export const ABILITIES: Record<string, AbilityDef> = {
  ...
  // ====================== ROOTWARDEN ======================
  // Exact numeric reskins of the hunter kit (same learnLevel/cost/castTime/
  // cooldown/range/school/effects/ranks): id + name + flavor retheme only, with
  // class:'rootwarden'. Any balance edit must move the hunter twin too.
  bond_kindred_spirit: {
    id: 'bond_kindred_spirit',
  ...
  trueroot_shot: {
    ...
    requiresTarget: true,
    effects: [{ type: 'directDamage', min: 50, max: 62 }],
    description: 'A carefully drawn shot that deals $d damage.',
  },
  ancestors_haste: {
    id: 'ancestors_haste',
