...
const titleOverrides: Partial<Record<SupportedLanguage, Record<string, string>>> = {
  pt_BR: {
    ...
    'Kindred Bond': 'Vínculo Ancestral',
    ...
    'Rootbound Instinct': 'Instinto das Raízes',
    ...
    'Wild Communion': 'Comunhão Selvagem',
    Wildfang: 'Feral',
    Wildsurge: 'Furor',
    ...
    // Rootwarden (10th class) talent tree node/mastery names.
    'Ancestral Aim Mastery': 'Maestria da Mira Ancestral',
    Barkhide: 'Pele de Casca',
    'Bloodroot Frenzy': 'Fúria da Raiz de Sangue',
    Deadeye: 'Olho Certeiro',
    'Efficient Aim': 'Mira Eficiente',
    "Hawk's Favor": 'Favor do Falcão',
    Heartroot: 'Raiz do Coração',
    'Improved Ancestral Shot': 'Tiro Ancestral Aprimorado',
    'Improved Rootsnare': 'Armadilha de Raízes Aprimorada',
    Ironbark: 'Casca de Ferro',
    'Keen Eye': 'Olhar Aguçado',
    'Keen Sight': 'Visão Aguçada',
    'Piercing Wounds': 'Feridas Perfurantes',
    "Predator's Edge": 'Vantagem do Predador',
    'Rending Snare': 'Armadilha Dilacerante',
    'Savage Claw': 'Garra Selvagem',
    Sidestep: 'Esquiva Lateral',
    'Spirit Tending': 'Cuidado Espiritual',
    'Swift Instinct': 'Instinto Veloz',
    'Thornfall Volley': 'Saraivada de Espinhos',
    Thornhide: 'Pele de Espinhos',
    'Trueshot Focus': 'Foco do Tiro Certeiro',
    'Unbound Fury': 'Fúria Desatada',
    Wayfinder: 'Desbravador',
    'Wild Fury': 'Fúria Selvagem',
    'Wild Instinct': 'Instinto Selvagem',
  },
};
