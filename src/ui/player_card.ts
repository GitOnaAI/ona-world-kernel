...
// The neutral template wordmark ("ONA WORLD KERNEL"), served from /public.
// Same-origin, so drawing it does not taint the canvas. Loaded best-effort: if
// it's missing the footer falls back to a text wordmark rather than failing
// the whole card. Replace with your game's own brand mark.
const LOGO_URL = '/ona-world-logo.png';
