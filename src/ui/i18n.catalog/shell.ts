...
export const shellStrings = {
  en: {
    seo: {
      ...
      officialBody:
        'This site is the sample home of Ona World Kernel, a free browser MMO template for the Claudemoon world. Play online with a persistent character or explore solo offline.',
    },
    a11y: {
