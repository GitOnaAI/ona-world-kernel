...
export const shellStrings = {
  en: {
    seo: {
      ...
      description:
        'Embark on an epic adventure in Ona World Kernel, a classic-style micro-MMO playable directly in your browser. Join a persistent shared world, level up classes, and defeat enemies!',
      genre: 'MMORPG',
      ...
      officialBody:
        'onaworld.example is the official free browser MMO for the Claudemoon world. Play online with a persistent character, explore solo offline, read the wiki, and follow verified community links from this site.',
    },
    a11y: {
  ...
  es: {
    seo: {
      title: 'Ona World Kernel: MMO web de estilo clásico',
      description:
        'Emprende una aventura épica en Ona World Kernel, un micro-MMO de estilo clásico que se juega directamente en el navegador. Entra a un reino compartido, sube de nivel y derrota enemigos.',
      genre: 'MMORPG',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Abre Ona World Kernel desde el nuevo icono de la pantalla de inicio.',
      ...
      androidOpenStep: 'Abre Ona World Kernel desde el nuevo icono.',
    ...
    serverUnavailable: {
      title: 'Ona World Kernel - Reino no disponible',
      logoAlt: 'Ona World Kernel',
  ...
  es_ES: {
    seo: {
      title: 'Ona World Kernel: MMO web de estilo clásico',
      description:
        'Emprende una aventura épica en Ona World Kernel, un micro-MMO de estilo clásico jugable directamente en el navegador. Únete a un reino compartido, sube clases de nivel y derrota enemigos.',
      genre: 'MMORPG',
      playMode: 'Multijugador',
      applicationCategory: 'Juego',
      operatingSystem: 'Navegador web',
  ...
  fr_FR: {
    seo: {
      title: 'Ona World Kernel: MMO web de style classique',
      description:
        'Partez pour une aventure épique dans Ona World Kernel, un micro-MMO au style classique jouable directement dans votre navigateur. Rejoignez un royaume persistant, progressez en classe et terrassez vos ennemis.',
      genre: 'MMORPG',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "Ouvrez Ona World Kernel depuis la nouvelle icône de l'écran d'accueil.",
      androidStandaloneDetail:
      ...
      androidOpenStep: 'Ouvrez Ona World Kernel depuis la nouvelle icône.',
    ...
    serverUnavailable: {
      title: 'Ona World Kernel - Royaume indisponible',
      logoAlt: 'Ona World Kernel',
  ...
  fr_CA: {
    seo: {
      title: 'Ona World Kernel: MMO Web de style classique',
      description:
        "Partez à l'aventure dans Ona World Kernel, un micro-MMO de style classique jouable directement dans votre navigateur. Rejoignez un royaume partagé, faites progresser vos classes et terrassez des ennemis.",
      genre: 'MMORPG',
      playMode: 'Multijoueur',
      applicationCategory: 'Jeu',
      operatingSystem: 'Navigateur Web',
  ...
  en_CA: {
    seo: {
      title: 'Ona World Kernel: Classic-Style Web MMO',
      description:
        'Embark on an epic adventure in Ona World Kernel, a classic-style micro-MMO playable directly in your browser. Join a persistent shared realm, level up classes, and defeat enemies!',
      genre: 'MMORPG',
      playMode: 'Multiplayer',
      applicationCategory: 'Game',
      operatingSystem: 'Web browser',
    ...
    serverUnavailable: {
      title: 'Ona World Kernel - Realm Unavailable',
      logoAlt: 'Ona World Kernel',
  ...
  it_IT: {
    seo: {
      title: 'Ona World Kernel: MMO web in stile classico',
      description:
        "Parti per un'avventura epica in Ona World Kernel, un micro-MMO in stile classico giocabile direttamente dal browser. Entra in un reame condiviso, fai crescere le classi e sconfiggi i nemici.",
      genre: 'MMORPG',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Apri Ona World Kernel dalla nuova icona nella schermata Home.',
      androidStandaloneDetail:
      ...
      androidOpenStep: 'Apri Ona World Kernel dalla nuova icona.',
    ...
    serverUnavailable: {
      title: 'Ona World Kernel - Reame non disponibile',
      logoAlt: 'Ona World Kernel',
  ...
  de_DE: {
    seo: {
      title: 'Ona World Kernel: Klassisches Web-MMO',
      description:
        'Begib dich in Ona World Kernel auf ein episches Abenteuer, ein Micro-MMO im klassischen Stil direkt im Browser. Betritt einen gemeinsamen Realm, steigere Klassen und besiege Gegner.',
      genre: 'MMORPG',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Öffne Ona World Kernel über das neue Symbol auf dem Home-Bildschirm.',
      ...
      androidOpenStep: 'Öffne Ona World Kernel über das neue Symbol.',
    ...
    serverUnavailable: {
      title: 'Ona World Kernel - Realm nicht verfügbar',
      logoAlt: 'Ona World Kernel',
  ...
  zh_CN: {
    seo: {
      title: 'Ona World Kernel：经典风格网页 MMO',
      description:
        '在 Ona World Kernel 展开史诗冒险。这是一款可直接在浏览器中游玩的经典风格微型 MMO。加入持续共享的服务器，提升职业等级，击败敌人。',
      genre: 'MMORPG',
      playMode: '多人游戏',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: '从新的主屏幕图标打开 Ona World Kernel。',
  ...
  zh_TW: {
    seo: {
      title: 'Ona World Kernel：經典風格網頁 MMO',
      description:
        '在 Ona World Kernel 展開史詩冒險。這是一款可直接在瀏覽器中遊玩的經典風格微型 MMO。加入持續共享的伺服器，提升職業等級並擊敗敵人。',
      genre: 'MMORPG',
      playMode: '多人遊戲',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: '從新的主畫面圖示開啟 Ona World Kernel。',
  ...
  ko_KR: {
    seo: {
      title: 'Ona World Kernel: 클래식 스타일 웹 MMO',
      description:
        '브라우저에서 바로 즐기는 클래식 스타일 마이크로 MMO, Ona World Kernel에서 장대한 모험을 시작하세요. 지속되는 공유 렐름에 접속해 직업을 성장시키고 적을 물리치세요.',
      genre: 'MMORPG',
      playMode: '멀티플레이어',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: '새 홈 화면 아이콘에서 Ona World Kernel를 여세요.',
  ...
  ja_JP: {
    seo: {
      title: 'Ona World Kernel: クラシック風Web MMO',
      description:
        'ブラウザで直接遊べるクラシック風マイクロMMO、Ona World Kernel で壮大な冒険に出ましょう。永続的な共有レルムに参加し、クラスを育て、敵を倒してください。',
      genre: 'MMORPG',
      playMode: 'マルチプレイヤー',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: '新しいホーム画面アイコンからOna World Kernelを開きます。',
  ...
  pt_BR: {
    seo: {
      title: 'Ona World Kernel: MMO web em estilo clássico',
      description:
        'Embarque em uma aventura épica em Ona World Kernel, um micro-MMO de estilo clássico jogável diretamente no navegador. Entre em um reino compartilhado, evolua classes e derrote inimigos.',
      genre: 'MMORPG',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Abra Ona World Kernel pelo novo ícone na tela inicial.',
      androidStandaloneDetail:
      ...
      androidOpenStep: 'Abra Ona World Kernel pelo novo ícone.',
    ...
    serverUnavailable: {
      title: 'Ona World Kernel - Reino indisponível',
      logoAlt: 'Ona World Kernel',
  ...
  ru_RU: {
    seo: {
      title: 'Ona World Kernel: веб-MMO в классическом стиле',
      description:
        'Отправьтесь в эпическое приключение в Ona World Kernel, микро-MMO в классическом стиле прямо в браузере. Присоединяйтесь к общему миру, развивайте классы и побеждайте врагов.',
      genre: 'MMORPG',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Откройте Ona World Kernel через новый значок на домашнем экране.',
      androidStandaloneDetail:
      ...
      androidOpenStep: 'Откройте Ona World Kernel через новый значок.',
    ...
    serverUnavailable: {
      title: 'Ona World Kernel - мир недоступен',
      logoAlt: 'Ona World Kernel',
