...
const EXPECTED_LINKS = [
  ...
  'https://github.com/GitOnaAI/ona-world-kernel',
];
...
async function main() {
  ...
  try {
    ...
    ok(title === 'Ona World Kernel - Official Links', `document.title is localized ("${title}")`);
    ...
    ok(EXPECTED_LINKS.filter((u) => u !== 'https://onaworld.example/').every((u) => sameAs.includes(u)),
